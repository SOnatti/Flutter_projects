...
class weatherDescript extends StatefulWidget {
  final dailyForecast;
  const weatherDescript({Key? key, this.dailyForecast}) : super(key: key);

  @override
  State<weatherDescript> createState() => weatherDescriptState();
}

class weatherDescriptState extends State<weatherDescript> {
  final constant_values _constant = constant_values();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _constant.brand,
      body: Stack(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  WeatherItem(
                                    ...
                                    unit: "%",
                                    imageUrl: "https://icons8.com/icon/3611/rainy-weather",
                                  ),
                                ],
                              ),
                            ),
